...
- 🗂️ **Боковое меню навигации (Drawer)**: удобный выдвижной сайдбар, разделяющий Главный экран, Диагностику сети, Журнал команд и Настройки без бесконечной вертикальной прокрутки.
- 🛠️ **Конструктор пользовательских пресетов**: создание, клонирование и тестирование собственных наборов команд с поддержкой динамического плейсхолдера маски сети `{{SAVED_MASK}}`.
- 📤 **Экспорт и импорт пресетов**: сохранение и обмен конфигурациями в формате JSON.
- 🎛️ **Плитка в быстрых настройках**: включение и отключение режима в один клик из шторки Android.
...
- 🎨 **Современный Material 3 интерфейс**: адаптивная верстка с поддержкой планшетов, системных панелей и тёмной темы.
